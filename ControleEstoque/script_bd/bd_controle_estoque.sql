...
-- -----------------------------------------------------
-- Table `controle_estoque`.`Pessoa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `controle_estoque`.`Pessoa` (
...
CREATE TABLE IF NOT EXISTS `controle_estoque`.`Funcionario` (
  ...
  CONSTRAINT `codPessoa`
    ...
    REFERENCES `controle_estoque`.`Pessoa` (`codPessoa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `controle_estoque`.`Saida` (
  ...
  CONSTRAINT `codFuncionario`
    ...
    REFERENCES `controle_estoque`.`Funcionario` (`codPessoa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `controle_estoque`.`Pedido` (
  ...
  CONSTRAINT `codFornecedor`
    ...
    REFERENCES `controle_estoque`.`Fornecedor` (`codPessoa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
