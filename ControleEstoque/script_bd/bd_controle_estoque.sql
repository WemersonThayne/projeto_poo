...
CREATE TABLE IF NOT EXISTS `controle_estoque`.`Produto` (
  ...
  PRIMARY KEY (`codProduto`, `Fornecedor_id`),
...
CREATE TABLE IF NOT EXISTS `controle_estoque`.`Pedido` (
  ...
  `hashPedido` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `controle_estoque`.`Saida_Produto` (
  ...
  `idProdutoSaida` INT NOT NULL,
  PRIMARY KEY (`idSaida`, `idProdutoSaida`),
  INDEX `idProduto_idx` (`idProdutoSaida` ASC),
  CONSTRAINT `idProduto`
...
CREATE TABLE IF NOT EXISTS `controle_estoque`.`Estoque` (
  ...
  INDEX `idProduto_idx` (`idProdutoEstoque` ASC),
  PRIMARY KEY (`idEstoque`),
  CONSTRAINT `idProduto`
    FOREIGN KEY (`idProdutoEstoque`)
    REFERENCES `controle_estoque`.`Produto` (`codProduto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
